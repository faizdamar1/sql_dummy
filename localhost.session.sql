...
SELECT count(*)
FROM 2_customer_orders -- 2. How many unique customer orders were made?
SELECT COUNT(DISTINCT(co.order_id)) unique_customer_order
FROM 2_customer_orders co -- 3. How many successful orders were delivered by each runner?
